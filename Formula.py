...
class Formula:
  ...
  def check_possible_fragment_mz(self, fragment_mz: Union[float, int], ppm: Union[float, int] = __default_ppm):
    ...
    Returns: a boolean specifying if the fragment m_z can be explained from the formula and the adduct
    Raise: a exception if fragment_mz or ppm are not numbers
    """
